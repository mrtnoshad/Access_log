CREATE OR REPLACE TABLE noshad.aim2_event_list_all_v3 as
SELECT 
...
SELECT ADT.jc_uid as jc_uid, 
  ...
  ADT.event_type || ' - ' || ADT.department_id as event_name,
...
( SELECT OP0.jc_uid as jc_uid, 
  OP0.pat_enc_csn_id_coded as enc_id, 
  'Procedure Start' as event_type, --|| OP0.description as event_type,
  OP0.proc_code as event_id,
  OP0.description as event_name,
